...
This page describes the Important Identifiers feature within the Corporate section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Corporate section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
