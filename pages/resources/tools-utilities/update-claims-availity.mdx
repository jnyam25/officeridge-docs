---
title: Update Claims Availity
description: Guidance and operational notes for Update Claims Availity.
---

import { Callout, Tabs, Steps } from '@/components';

# Update Claims Availity
...
This page describes the Update Claims Availity feature within the Tools Utilities section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Tools Utilities section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
...
<Steps>
  <Step title="Access">
    Open the Update Claims Availity page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Update Claims Availity according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Update Claims Availity; Contact support if data should be present |
...
<Tabs>
  <Tab title="Related Docs">
    ...
    - [Employee Maps](./employee-maps)
    - [Important Identifiers](./important-identifiers)
  </Tab>
</Tabs>
