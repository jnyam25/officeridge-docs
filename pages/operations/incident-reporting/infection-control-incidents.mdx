---
title: Infection Control Incidents
description: Guidance and operational notes for Infection Control Incidents.
---
...
This page describes the Infection Control Incidents feature within the Incident Reporting section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Incident Reporting section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
...
<Steps>
  <Step title="Access">
    Open the Infection Control Incidents page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Infection Control Incidents according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Infection Control Incidents; Contact support if data should be present |

## Related Documentation

<Tabs>
  <Tab title="Related Docs">
    - [Fall Incidents](./fall-incidents)
    - [Fraud Incidents](./fraud-incidents)
    - [Hipaa Incidents](./hipaa-incidents)
    - [Home Hazard Incidents](./home-hazard-incidents)
  </Tab>
</Tabs>
