...
description: Guidance and operational notes for Storage Locations.
---
...
This page describes the Storage Locations feature within the Management Directory section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Steps>
  <Step title="Access">
    Open the Storage Locations page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Storage Locations according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Storage Locations; Contact support if data should be present |
...
<Tabs>
  <Tab title="Related Docs">
    ...
    - [Calendar](./calendar)
    - [Certification Identity](./certification-identity)
