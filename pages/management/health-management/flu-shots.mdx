---
title: Flu Shots
description: Guidance and operational notes for Flu Shots.
---
...
This page describes the Flu Shots feature within the Health Management section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Steps>
  <Step title="Access">
    Open the Flu Shots page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Flu Shots according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Flu Shots; Contact support if data should be present |
