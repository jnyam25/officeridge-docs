---
title: Emergency Prep Plan Review
description: Guidance and operational notes for Emergency Prep Plan Review.
---

import { Callout, Tabs, Steps } from '@/components';

# Emergency Prep Plan Review
...
This page describes the Emergency Prep Plan Review feature within the Planning Documents section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Planning Documents section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
...
<Steps>
  <Step title="Access">
    Open the Emergency Prep Plan Review page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Emergency Prep Plan Review according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Emergency Prep Plan Review; Contact support if data should be present |
