...
This page describes the Business Associate Agreements feature within the Vendors section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Vendors section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
