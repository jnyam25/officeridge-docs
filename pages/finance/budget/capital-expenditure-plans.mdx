...
description: Guidance and operational notes for Capital Expenditure Plans.
---
...
This page describes the Capital Expenditure Plans feature within the Budget section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Budget section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
...
<Steps>
  <Step title="Access">
    Open the Capital Expenditure Plans page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Capital Expenditure Plans according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Capital Expenditure Plans; Contact support if data should be present |
...
<Tabs>
  <Tab title="Related Docs">
    - [Budgets](./budgets)
    - [Budget](./)
    - [Strategic Business Plans](./strategic-business-plans)
  </Tab>
</Tabs>
