---
title: Evv Usage Scores
description: Guidance and operational notes for Evv Usage Scores.
---
...
This page describes the Evv Usage Scores feature within the Time And Attendance section of the OfficeRidge platform. It offers an overview of common workflows, role access, compliance expectations, and key tasks.
...
<Tabs>
  ...
  <Tab title="Related Modules">
    See the Time And Attendance section index and adjacent workflows for related functionality.
  </Tab>
</Tabs>
...
<Steps>
  <Step title="Access">
    Open the Evv Usage Scores page from the relevant module navigation and review the available actions.
  </Step>
...
<Callout type="info">
  Use Evv Usage Scores according to your role permissions. Access and changes are logged per OfficeRidge compliance standards, and any PHI-related tasks must follow HIPAA requirements and internal audit policies.
</Callout>

## Troubleshooting

| Action fails to complete | Verify you have the required permissions; Refresh the page; Confirm required fields are filled |
| Information appears missing | Check that the page selection and filters are correct for Evv Usage Scores; Contact support if data should be present |

## Related Documentation

<Tabs>
  <Tab title="Related Docs">
    - [Evv Credentials](./evv-credentials)
    - [Evv Resources](./evv-resources)
    - [Time And Attendance](./)
  </Tab>
</Tabs>
